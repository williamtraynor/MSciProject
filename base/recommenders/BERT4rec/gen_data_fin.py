...
from base.recommenders.BERT4rec.util import *
from base.recommenders.BERT4rec.vocab import *
import pickle
...
def get_training_documents_no_force_last(all_users_raw, max_seq_length, prop_sliding_window):
    ...
    print('Prop Sliding Window: ', prop_sliding_window)
    print('Max Num Tokens: ', max_num_tokens)
    sliding_step = (int)(
        prop_sliding_window *
